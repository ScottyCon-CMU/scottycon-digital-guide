...
export function TableTypeChip({ type }: {
    ...
    return (
        <div className="font-mono text-xs px-2 py-1 rounded-sm flex items-center gap-1 bg-primary/10 text-secondary dark:text-foreground">
            {type === "artist" ? <><Users size={10} />Artist</>
